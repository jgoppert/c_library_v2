...
#define MAVLINK_MSG_ID_ESTIMATOR_STATE 269
...
typedef struct __mavlink_estimator_state_t {
 ...
 float state[21]; /*< The estimator state*/
...
#define MAVLINK_MSG_ID_ESTIMATOR_STATE_LEN 135
#define MAVLINK_MSG_ID_ESTIMATOR_STATE_MIN_LEN 135
#define MAVLINK_MSG_ID_269_LEN 135
#define MAVLINK_MSG_ID_269_MIN_LEN 135

#define MAVLINK_MSG_ID_ESTIMATOR_STATE_CRC 246
#define MAVLINK_MSG_ID_269_CRC 246

#define MAVLINK_MSG_ESTIMATOR_STATE_FIELD_STATE_LEN 21
#define MAVLINK_MSG_ESTIMATOR_STATE_FIELD_ID_LEN 21
#define MAVLINK_MSG_ESTIMATOR_STATE_FIELD_SENSOR_LEN 21
...
#define MAVLINK_MESSAGE_INFO_ESTIMATOR_STATE { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_estimator_state_t, time_usec) }, \
         { "state", NULL, MAVLINK_TYPE_FLOAT, 21, 8, offsetof(mavlink_estimator_state_t, state) }, \
         { "n", NULL, MAVLINK_TYPE_UINT8_T, 0, 92, offsetof(mavlink_estimator_state_t, n) }, \
         { "id", NULL, MAVLINK_TYPE_UINT8_T, 21, 93, offsetof(mavlink_estimator_state_t, id) }, \
         { "sensor", NULL, MAVLINK_TYPE_UINT8_T, 21, 114, offsetof(mavlink_estimator_state_t, sensor) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ESTIMATOR_STATE { \
                               ...
                               uint64_t time_usec, uint8_t n, const uint8_t *id, const uint8_t *sensor, const float *state)
{
    ...
    _mav_put_float_array(buf, 8, state, 21);
    ...
    packet.n = n;
    mav_array_memcpy(packet.state, state, sizeof(float)*21);
...
{
    return _MAV_RETURN_float_array(msg, state, 21,  8);
}
