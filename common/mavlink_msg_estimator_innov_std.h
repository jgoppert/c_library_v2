...
typedef struct __mavlink_estimator_innov_std_t {
 ...
 float std[21]; /*< The estimator innovation standard deviation sqrt(diag(S))*/
...
#define MAVLINK_MSG_ESTIMATOR_INNOV_STD_FIELD_SENSOR_LEN 21
...
#define MAVLINK_MESSAGE_INFO_ESTIMATOR_INNOV_STD { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_estimator_innov_std_t, time_usec) }, \
         { "std", NULL, MAVLINK_TYPE_FLOAT, 21, 8, offsetof(mavlink_estimator_innov_std_t, std) }, \
         { "n", NULL, MAVLINK_TYPE_UINT8_T, 0, 92, offsetof(mavlink_estimator_innov_std_t, n) }, \
         { "id", NULL, MAVLINK_TYPE_UINT8_T, 21, 93, offsetof(mavlink_estimator_innov_std_t, id) }, \
         { "sensor", NULL, MAVLINK_TYPE_UINT8_T, 21, 114, offsetof(mavlink_estimator_innov_std_t, sensor) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_ESTIMATOR_INNOV_STD { \
